...
<div class="container">
        ...
        <div class="row">
            ...
            <div class="col col-md-6">
                <fieldset class="rounded mb-4">
                    <legend class="w-auto py-1 rounded">{{__('users.change_profile_image')}}</legend>
                    <div class="row">
                        <div class="col col-md-6">
                            <div class="uploaded-image">
                                <img id="profile_image_preview" src="{{ asset($user->profile->image ?? 'profile_default_icon.png') }}" 
                        ...
                        <div class="col col-md-6">
                            <form action="{{ route('admin-users-change-profile-image', $user->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                @method('PUT')
                                <div class="input-group mb-2">
                                    <label class="input-group-text">{{__('users.profile_image')}}</label>
