...
<div class="container">
    ...
    <form action="{{ route('admin-clients-update', $client->id) }}" method="POST">
        ...
        <div class="input-group mb-2">
            <label for="name_ar" class="input-group-text" data-bs-toggle="tooltip" data-bs-title="{{__('clients.name_ar')}}">
                <i class="fa fa-language"></i> &nbsp; {{__('clients.name_ar')}} <span class="text-danger">*</span></label>
        ...
        <div class="input-group mb-2">
            <label for="name_en" class="input-group-text" data-bs-toggle="tooltip" data-bs-title="{{__('clients.name_en')}}">
                <i class="fa fa-language"></i> &nbsp; {{__('clients.name_en')}} <span class="text-danger">*</span></label>
        ...
        <div class="input-group mb-3">
            ...
            <label for="identity_number" class="input-group-text" data-bs-toggle="tooltip" data-bs-title="{{__('clients.identity_number')}}">
        ...
        <!-- المعلومات المالية -->
        <div class="input-group mb-3">
            <label for="commercial_record" class="input-group-text" data-bs-toggle="tooltip" data-bs-title="{{__('clients.commercial_record')}}"><i class="fa fa-credit-card"></i></label>
            ...
            <label for="tax_number" class="input-group-text" data-bs-toggle="tooltip" data-bs-title="{{__('clients.tax_number')}}"><i class="fa fa-money-bill"></i></label>
        ...
        <div class="input-group mb-3">
            <label for="brand_name" class="input-group-text" data-bs-toggle="tooltip" data-bs-title="{{__('clients.brand_name')}}"><i class="fa fa-trademark"></i></label>
            ...
            <label for="s_number" class="input-group-text" data-bs-toggle="tooltip" data-bs-title="{{__('clients.s_number')}}">
                <i class="fa fa-sort-numeric-asc"></i></label>
            <input type="button" class="form-control" value="{{old('s_number', $client->s_number)}}">
        </div>
            
        <!-- معلومات الاتصال -->
        <div class="input-group mb-2">
            <label for="phone" class="input-group-text" data-bs-toggle="tooltip" data-bs-title="{{__('clients.phone_number')}}"><i class="fa fa-phone"></i></label>
            <input type="text" id="phone" name="phone" class="form-control" placeholder="{{__('clients.phone_number')}}" value="{{old('phone', $client->phone)}}">
        
            <label for="mobile" class="input-group-text" data-bs-toggle="tooltip" data-bs-title="{{__('clients.mobile_number')}}"><i class="fa fa-mobile"></i> <span class="text-danger">*</span></label>
        ...
        <div class="input-group mb-2">
            <label for="email" class="input-group-text" data-bs-toggle="tooltip" data-bs-title="{{__('clients.email')}}"><i class="fa fa-at"></i></label>
            <input type="email" id="email" name="email" class="form-control" placeholder="{{__('clients.email')}}" value="{{old('email', $client->email)}}">
        
            <label for="website" class="input-group-text" data-bs-toggle="tooltip" data-bs-title="{{__('clients.website')}}"><i class="fa fa-globe"></i></label>
        ...
        <div class="input-group mb-3">
            <label for="city" class="input-group-text" data-bs-toggle="tooltip" data-bs-title="{{__('clients.city')}}"><i class="fa fa-map-marker"></i></label>
            <input type="text" id="city" name="city" class="form-control" placeholder="{{__('clients.city')}}" value="{{old('city', $client->city)}}">
        
            <label for="address" class="input-group-text" data-bs-toggle="tooltip" data-bs-title="{{__('clients.address')}}"><i class="fa fa-location-dot"></i></label>
        ...
        <div class="row mb-4">
            <div class="col-md-8">
                <div class="input-group mb-3">
                    <label for="notes" class="input-group-text" data-bs-toggle="tooltip" data-bs-title="{{__('clients.notes')}}"><i class="fa fa-pen-to-square"></i></label>
        ...
        <div class="input-group">
            <button type="button" class="form-control btn btn-outline-secondary" data-bs-dismiss="modal">{{__('clients.close')}}</button>
            <button type="submit" class="form-control btn btn-outline-success">{{__('clients.update')}}</button>
        </div>
    </form>
</div>
@endsection
