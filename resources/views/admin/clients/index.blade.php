...
<div class="container">
    <fieldset class="">
        <legend class="">{{__('clients.clients_list_heading')}}
            <a href="{{ route('admin-clients-create') }}" 
                data-bs-toggle="modal" data-bs-target="#addClientModal">
                <i data-bs-toggle="tooltip" data-bs-title="{{ __('clients.create') }}" 
                class="fa fa-plus"></i>
            </a>
        </legend>
        <div class="px-3">
            <table id="myTable" class="">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $client->city }}</td>
                        <td>
                            <a href="{{ route('admin-clients-show', $client->id) }}" class="btntext-success" data-bs-toggle="tooltip" data-bs-title="{{__('clients.show')}}"><i class="fa fa-eye"></i></a>
                            <a href="{{ route('admin-clients-edit', $client->id) }}" class="btntext-primary" data-bs-toggle="tooltip" data-bs-title="{{__('clients.edit')}}"><i class="fa fa-edit"></i></a>
                            <form id="deleteForm" action="{{ route('admin-clients-destroy', $client->id) }}" method="POST" style="display:inline;">
                                @csrf
                                @method('DELETE')
                                <button type="submit" 
                                    onclick="return confirm('{{ __('clients.are_you_sure') }}')"
                                    class="btn text-danger" data-bs-toggle="tooltip" 
                                    data-bs-title="{{ __('clients.delete') }}">
